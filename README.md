...
- 🎯 Entry points to execute your program using `python -m <hey_siwi>` or `$ hey_siwi` with basic CLI argument parsing.
...
Awesome hey_siwi created by nonik102
...
```py
from hey_siwi import BaseClass
from hey_siwi import base_function
